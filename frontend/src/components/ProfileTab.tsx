...
export default function ProfileTab() {
    ...
    const handleGoogleSignIn = () => {
        // Placeholder — Firebase Auth integration goes here
        setIsSignedIn(true);
        setUserName("Trader");
    };
    ...
    return (
        <div className="mx-auto max-w-lg space-y-6">
            ...
            <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-md p-6 text-center">
                {/* Avatar */}
                <div className="mx-auto mb-4 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-violet-500 to-blue-500 shadow-lg shadow-violet-500/25">
                    {isSignedIn ? (
                ...
                {isSignedIn ? (
                    <>
                        ...
                        <p className="text-xs text-slate-400 mb-4">Connected Account</p>
                        <button
                    ...
                    <>
                        ...
                        <p className="text-xs text-slate-400 mb-5">
                            Sign in to save your preferences and credentials securely
                        </p>
                        <button
            ...
            <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-md p-5 space-y-4">
                ...
                <div className="space-y-3">
                    <div className="flex items-center justify-between rounded-lg bg-white/5 ring-1 ring-white/10 p-3">
                        ...
                        <span
                            className={`rounded-full px-3 py-0.5 text-xs font-semibold ${isSignedIn
