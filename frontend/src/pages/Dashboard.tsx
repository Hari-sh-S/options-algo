...
const OrderHistory = lazy(() => import("@/components/EntrySummary"));
const LivePositions = lazy(() => import("@/components/LivePositions"));
const PnlDashboard = lazy(() => import("@/components/PnlDashboard"));
const ScheduledJobs = lazy(() => import("@/components/ScheduledJobs"));

// Fallback skeleton for lazy loaded components
const LazyFallback = () => (
  ...
  return (
    <div className="min-h-screen bg-[#0a0a14]">
      ...
      <div className="relative z-10">
        ...
        <main className="mx-auto max-w-7xl px-4 sm:px-6 py-6 border-transparent">
